...
def build_ui():
    ...
    with st.sidebar:
        ...
        st.text("Please enter unique ticker symbol\nto avoid errors.")
        ...
        for n in range(st.session_state['num_pairs']):
            ...
            if ticker and value > 0:
                if ticker in tickers_and_values.keys():
                    raise Exception("Duplicated ticker symbols. Please refresh this page and try again.")
                else:
